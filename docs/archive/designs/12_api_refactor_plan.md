...
- `POST /knowledge/graph/knowledge-units/detail`
...
- `overview` -> `knowledge_unit + knowledge_edge`
...
- 当前 `/knowledge/overview` 只承载知识图谱和统计摘要。
- `snapshot / theme_tree / prereq_dag` 属于未来课程结构能力，不属于当前 API。
