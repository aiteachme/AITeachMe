...
| 节点 | 角色 | 路由 |
|------|------|------|
| Load Raw File | 🔀 条件路由 | `continue` -> Compute Fingerprint / `fail` -> Finalize Failure |
| Compute Fingerprint | 🔀 条件路由 | `continue` -> Classify File / `fail` -> Finalize Failure |
| Classify File | 🔀 条件路由 | `fail` -> Finalize Failure / `continue` -> Plan Parse |
| Plan Parse | 🔀 条件路由 | `fail` -> Finalize Failure / `continue` -> Parse File |
