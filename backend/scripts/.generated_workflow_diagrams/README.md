...
| 模块 | 文件 | 包含的子工作流 |
|------|------|----------------|
| 🧬 Digest Engine · 消化引擎 | [digest.md](digest.md) | Digest Planner Workflow / Digest DocGen Workflow / Digest Graph Workflow / Digest Curriculum Workflow / Digest Unified Workflow |
