"""Keep raw-file origin subject as audit data only."""
        ...
        BEGIN
            FOR constraint_name IN
                ...
                WHERE n.nspname = current_schema()
                  ...
                  AND a.attname = 'origin_subject_id'
                  AND rt.relname = 'subject'
            LOOP
...
def downgrade() -> None:
    raise RuntimeError("Downgrading raw_file origin subject audit semantics is not supported.")
