...
def test_openmaic_style_review_rejects_protocol_relative_unapproved_resource() -> None:
    html = """<!DOCTYPE html>
<html lang="zh-CN">
<head>
  <meta charset="utf-8" />
  <meta name="viewport" content="width=device-width, initial-scale=1" />
  <script src="//evil.example/widget.js"></script>
</head>
<body><main>交互演示</main></body>
    ...
    assert "HTML 包含未允许的远程资源域名：evil.example。" in validation_issues
    assert not quality_report.passed
