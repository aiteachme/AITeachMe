...
from app.teaching.memory.store import get_memory_store
...
async def remember(
    ...
    *,
    ...
    Example::
        ...
        from app.teaching.memory.api import remember
...
async def recall(
    ...
    *,
    ...
    Example::
        ...
        from app.teaching.memory.api import recall
...
async def get_user_profile(user_id: str = "default") -> UserProfile:
    ...
    Example::
        ...
        from app.teaching.memory.api import get_user_profile
...
async def log_learning_event(
    ...
    *,
    ...
    Example::
        ...
        from app.teaching.memory.api import log_learning_event
