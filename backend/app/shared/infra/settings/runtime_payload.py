...
`.env` remains a bootstrap/default source, and non-empty DB values win per key
once the user edits them in the app. Blank values are not stored as overrides;
they mean "fall back to `.env` / process env".
"""
