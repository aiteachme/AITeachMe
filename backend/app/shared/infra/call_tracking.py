"""In-memory LLM call and span tracking (independent of LangSmith).

This module provides lightweight, process-local observability primitives
for recording LLM calls and spans. It has no dependency on LangSmith.
"""
...
@dataclass
class Span:
    """A simple span primitive for in-memory tracing."""
