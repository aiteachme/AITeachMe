...
对外只需一行调用::
    ...
    from app.infra.agent_loop import run_agent_loop
...
async def run_agent_loop(
    ...
    *,
    ...
    from app.infra.llm import acompletion, acompletion_with_tools
    from app.infra.tools.registry import get_tool_registry
...
async def run_agent_loop_stream(
    ...
    *,
    ...
    Example::
        ...
        from app.infra.agent_loop import run_agent_loop_stream
        async for chunk in run_agent_loop_stream(messages, tools=["search_kb"]):
            print(chunk, end="")
    """

    from app.infra.llm import acompletion_stream, acompletion_with_tools
    from app.infra.tools.registry import get_tool_registry
