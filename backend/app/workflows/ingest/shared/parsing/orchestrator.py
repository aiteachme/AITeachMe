...
from app.workflows.ingest.shared.parsing.asset_ocr import enhance_markdown_with_asset_ocr
...
from app.workflows.ingest.shared.parsing.parsers import PARSER_REGISTRY, resolve_parser_extension
from app.workflows.ingest.shared.parsing.pdf_page_fallback import enhance_pdf_markdown_with_page_fallback
    ...
    *,
    ...
    for parser_name in plan.parser_chain:
        ...
        try:
            ...
            from app.workflows.ingest.shared.parsing.formats import is_text_extension
            needs_enhance = (
