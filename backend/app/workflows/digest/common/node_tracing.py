"""Small authoring helpers for digest LangGraph node tracing."""
...
def node_metadata(
    *,
    ...
    passthrough_keys: tuple[str, ...] = ("fanout", "fanin", "routing"),
) -> dict[str, object]:
...
def traced_digest_node(
    ...
    *,
    ...
    """Wrap one digest node with consistent trace metadata."""
