...
1. 基础起点：决定前置概念补多少、第一章铺垫长度、首批例题难度。
2. 讲解重心：决定章节优先级、正文篇幅分配、例题类型。
3. 练习/测试密度：决定随堂练习、变式题、章末小测题量。
4. 测后反馈方式：决定答案解析粒度、错因提醒、订正或复习建议。
...
purpose 必须以“文档落点：”开头，并写清这题会改变哪些实际文档部件，例如章节顺序、讲解起点、例题难度、练习密度、章末小测题型、答案解析或错因提示。

输出前自检：
- JSON 数组正好 4 项。
- 每项都有 question、purpose、options。
- 每个 options 正好 4 个不重复短标签。
- 四题分别落到基础起点、讲解重心、练习/测试密度、测后反馈方式。
...
5. good question 示例：“基础从哪起？”“讲解重哪里？”“练习怎么放？”“测后怎么看？”。
6. good option 示例：“先补基础”“概念先讲”“例题带路”“多练变式”“章末小测”“错因提醒”“步骤解析”“只给要点”。
