...
输出内容要求：
1. plan：180-360 字，讲清学习范围、拆分逻辑、先后顺序、练习/易错/应用安排。
2. suggestion：2-4 句，给出用户可继续调整的方向，例如偏考试、延长周期、增加例题密度、减少拓展、改章节数。
3. chapters：输出完整章节列表；title 写可直接授课的核心学习单元，聚焦知识对象、方法步骤、题型技能或应用场景；key_points 2-4 条承接细节、例题、练习或测验。
4. 标题使用课程目录语言，保留必要限定词；资料来源、文件名、页码、天数等元信息只放上下文，不进标题。
5. 复习、练习和测验归入相关章节 key_points。
