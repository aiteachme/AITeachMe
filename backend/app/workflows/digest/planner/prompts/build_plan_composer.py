...
四题需要覆盖不同落点：基础起点、讲解重心、练习/测试密度、图示/辅助方式；不要四题都问同一类偏好。
...
5. 可用题目示例：“基础从哪起？”“讲解重哪里？”“练习怎么放？”“图示怎么用？”。
6. 可用选项示例：“先补基础”“例题带路”“多练变式”“章末小测”“少量关键图”。

严格按以下格式输出：
{DIAGNOSE_START}
[{{"question":"问题文本","purpose":"文档落点：影响的章节、例题、图示或练习配置","options":["短选项一","短选项二","短选项三","短选项四"]}}]
{DIAGNOSE_END}
""".strip()
    messages = [
        {"role": "system", "content": system_prompt},
