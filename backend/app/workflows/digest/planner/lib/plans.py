...
from app.workflows.digest.planner.lib.fallback_specs import (
    ChapterAngleSpec,
...
def _build_fallback_chapter_title(
    *,
    ...
    suffix = title_suffix_for_angle(digest_mode=digest_mode, angle=angle)
...
def _build_fallback_chapter_plan(
    *,
    ...
    angle_specs = angle_specs_for_mode(digest_mode)
    chapter_plan: list[PlannerChapterPlan] = []
