...
_SPRINT_PROFILE = DocGenModeProfile(
    ...
    example_density_policy={
        ...
        "policy_text": "快速复习节奏必须高密度使用例题、案例、变式、自测或实践任务；理论只服务会做题、会操作、会判断、会避坑。考试、计算或刷题类章节必须有自然生成的常见题型整理，并配足带解析和易错点的例题区。",
    },
    coverage_policy=(
