...
5. stem、answer、basis 都要短，公式使用 Markdown/LaTeX，例如 `$f(x)$` 或 `$$...$$`，不要输出 HTML。
6. 选择题的 options 字段必须正好 4 项，stem 中不要再重复写 A/B/C/D；非选择题 options 填空数组 []。
7. 填空题必须有明确空位；步骤排序必须给出待排序步骤。
