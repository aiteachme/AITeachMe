...
4. 系统学习要讲清定义、结构和推理；快速复习节奏要按章节角色强化内容：训练型章节多给常见任务/题型、例题训练和易错点，概念型章节用短例子、反例和条件辨析增强直观性。
5. 标题必须像真实课程目录一样能单独看懂：按本章具体对象、题型、方法或场景命名，不要把“知识速查表”“综合训练”“快速自测”“常见任务整理”“补充讲解”这类泛标签当小节名。
