"""Unified digest workflow package with lazy exports."""
...
_ATTR_TO_MODULE = {
    "UnifiedBuildResult": "app.workflows.digest.unified.state",
    "UnifiedDigestState": "app.workflows.digest.unified.state",
