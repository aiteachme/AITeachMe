...
class KnowledgeGraphBuildService:
    ...
    def get_build_result(self, *, subject: str) -> DocGenGetResponse:
        from app.workflows.digest.docgen.builds import get_docgen_result
    ...
    async def run_graph_build_background(
        ...
        *,
        ...
        from app.workflows.digest.knowledge_graph.builds import run_graph_build_background
    ...
    async def run_graph_digest_background(
        ...
        *,
        ...
        from app.workflows.digest.knowledge_graph.builds import run_graph_digest_background
