# kg_doc_sync Workflow

`kg_doc_sync` is the canonical product lane for syncing the latest published
...
Use `app.workflows.digest.kg_doc_sync.lib.extraction` and
`app.workflows.digest.kg_doc_sync.lib.incremental_sync` for docs-sync
