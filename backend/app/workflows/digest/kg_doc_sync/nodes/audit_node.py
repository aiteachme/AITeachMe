...
def _audit_metrics(payload: KnowledgeSyncExtractionPayload, *, elapsed_ms: int) -> dict[str, object]:
    ...
    return {
        ...
        "exam_ready_target_count": int(diagnostics.get("graph_audit_exam_ready_target_count", 0) or 0),
        "exam_ready_gap_count": int(diagnostics.get("graph_audit_exam_ready_gap_count", 0) or 0),
        "exam_ready_chapter_floor": int(diagnostics.get("graph_audit_exam_ready_chapter_floor", 0) or 0),
        "exam_ready_low_chapter_count": int(diagnostics.get("graph_audit_exam_ready_low_chapter_count", 0) or 0),
