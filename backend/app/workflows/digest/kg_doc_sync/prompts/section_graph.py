...
11. 为前端可视化服务：节点名称尽量控制在 2-12 个中文字符或一个简短公式；过长标题要压缩成核心术语。
12. `local_summary` 要说明这个节点在当前片段里的教学价值，例如定义了什么、解决什么、依赖什么或容易错在哪里，不要只复述节点名。
13. 关系优先表达“前置依赖、组成结构、公式适用、方法步骤、例题验证、易错对比”，不要为了连线而创造泛泛的 related_to。
