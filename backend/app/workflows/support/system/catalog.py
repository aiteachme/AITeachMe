...
SETTINGS_CATALOG: tuple[SettingsCatalogSection, ...] = (
    ...
    SettingsCatalogSection(
        id="models",
        label="模型路由",
        description="文本生成路由与多模态能力模型。默认只预填文本生成与 embedding，其他能力按需启用。",
        entries=(
            setting(
                "models.primary",
                "主文本模型",
    ...
    SettingsCatalogSection(
        ...
        entries=(
            ...
            setting(
                ...
                "解析服务",
                description="默认本地解析保持现有链路；选择 MinerU、PaddleOCR、OCR 或 MarkItDown 后，新上传文件会优先使用对应服务。",
                ui_group="解析服务授权",
                ui_order=30,
            ),
            env(
            ...
            env(
                ...
                description="服务端 PaddleOCR Cloud Token，只显示是否已配置。",
                secret=True,
                ui_group="解析服务授权",
                ui_order=45,
            ),
            env(
                ...
                "OCR 模型网关地址",
                "OCR_BASE_URL",
                description="留空时复用统一模型网关地址。",
                value_path="llm_base_url",
                restart_required=False,
                ui_group="解析服务授权",
                ui_order=50,
            ),
            env(
                ...
                "OCR 模型 API Key",
                "OCR_API_KEY",
                description="留空时复用统一模型网关密钥。",
                value_path="llm_api_key",
                secret=True,
                restart_required=False,
                ui_group="解析服务授权",
                ui_order=60,
    ...
    SettingsCatalogSection(
        ...
        entries=(
            ...
            env("search.tavily_key", "Tavily 密钥", "TAVILY_API_KEY", description="Tavily 搜索密钥。", secret=True, ui_group="联网搜索授权", ui_order=90),
            env("search.brave_key", "Brave Search 密钥", "BRAVE_SEARCH_API_KEY", description="Brave Search 密钥。", secret=True, ui_group="联网搜索授权", ui_order=100),
            env("search.exa_key", "Exa 搜索密钥", "EXA_API_KEY", description="Exa 语义搜索密钥。", secret=True, ui_group="联网搜索授权", ui_order=110),
            env("search.bing_key", "Bing Search 密钥", "BING_API_KEY", description="Bing Search 密钥。", secret=True, ui_group="联网搜索授权", ui_order=120),
            env("search.bocha_key", "Bocha 搜索密钥", "BOCHA_API_KEY", description="Bocha 搜索密钥。", secret=True, ui_group="联网搜索授权", ui_order=130),
            env("search.jina_key", "Jina 搜索密钥", "JINA_API_KEY", description="Jina Search / Reader 共用密钥。", secret=True, ui_group="联网搜索授权", ui_order=140),
            env("search.serper_key", "Serper 搜索密钥", "SERPER_API_KEY", description="Serper Google / Scholar 搜索密钥。", secret=True, ui_group="联网搜索授权", ui_order=150),
            env("search.perplexity_key", "Perplexity 搜索密钥", "PERPLEXITY_API_KEY", description="Perplexity Sonar 搜索密钥。", secret=True, ui_group="联网搜索授权", ui_order=160),
            env("search.openrouter_key", "OpenRouter 搜索密钥", "OPENROUTER_API_KEY", description="OpenRouter 搜索模型密钥。", secret=True, ui_group="联网搜索授权", ui_order=170),
            env("search.baidu_ai_key", "百度千帆搜索密钥", "BAIDU_AI_SEARCH_API_KEY", description="百度千帆 AI Search 密钥。", secret=True, ui_group="联网搜索授权", ui_order=180),
            env("search.google_key", "Google 搜索密钥", "GOOGLE_API_KEY", description="Google Custom Search API Key。", secret=True, ui_group="联网搜索授权", ui_order=190),
            env("search.google_cx", "Google 搜索引擎 ID", "GOOGLE_CX_KEY", description="Google Custom Search Engine ID。", secret=True, ui_group="联网搜索授权", ui_order=200),
            env("search.searchapi_key", "SearchApi 密钥", "SEARCHAPI_API_KEY", description="SearchApi.io 搜索密钥。", secret=True, ui_group="联网搜索授权", ui_order=210),
            env("search.serpapi_key", "SerpApi 密钥", "SERPAPI_API_KEY", description="SerpApi 搜索密钥。", secret=True, ui_group="联网搜索授权", ui_order=220),
            env("search.ncbi_key", "NCBI / PubMed 密钥", "NCBI_API_KEY", description="NCBI / PubMed API Key，可选。", secret=True, ui_group="联网搜索授权", ui_order=230),
        ),
    ),
    SettingsCatalogSection(
        id="observability",
