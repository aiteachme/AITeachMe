...
class DocGenBuildRequest(BaseModel):
    ...
    confirmed_plan_id: str | None = Field(
        default=None,
        description="Optional confirmed build plan identifier generated by the planner workflow. When supplied, the build uses the plan-selected files and frozen planner goal as the effective build contract.",
    )
