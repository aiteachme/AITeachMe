...
class KnowledgeGraphSyncRun(SQLModel, table=True):
    ...
    __table_args__ = (
        Index("ix_kg_sync_run_course_revision", "course_id", "graph_revision_no"),
        Index("ix_kg_sync_run_course_doc_version", "course_id", "doc_version_no"),
    )
...
class KnowledgeGraphSourceRef(SQLModel, table=True):
    ...
    __table_args__ = (
        ...
        Index("ix_kg_source_ref_course_chapter", "course_id", "chapter_index"),
    )
