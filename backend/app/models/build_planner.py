...
class ConfirmedBuildPlan(SQLModel, table=True):
    ...
    user_prompt: str = Field(default="", sa_column=Column(sa.Text(), nullable=False, default=""))
    ...
    plan_summary: str = Field(default="", sa_column=Column(sa.Text(), nullable=False, default=""))
