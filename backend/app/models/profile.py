...
class UserKnowledgeState(SQLModel, table=True):
    ...
    review_reason: str | None = Field(default=None, sa_column=sa.Column(sa.Text(), nullable=True))
    ...
    stats_json: str = Field(default="{}", sa_column=sa.Column(sa.Text(), nullable=False, default="{}"))
