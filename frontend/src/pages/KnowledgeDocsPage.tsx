...
export function KnowledgeDocsPage() {
  const { openAssistant, isOpen: isAssistantOpen } = useSubjectAiAssistant();
  ...
  const openCommentComposer = useCallback(() => {
    ...
    setFloatingInput("");
    clearSelectionHighlight();
  }, [addSelectionHighlight, captureSelectionSegments, clearSelectionHighlight, createLocalThreadId, floatingToolbar, openAssistant]);
  ...
  const openAiAssistant = useCallback((threadId?: string) => {
    ...
    openAssistant();
  }, [activeThreadId, commentThreadById, commentThreadIds, openAssistant, selectionHighlights, subjectId, threadSessionIds]);
  ...
  const openSelectionHighlightThread = useCallback((threadId: string) => {
    ...
    openAiAssistant(threadId);
  }, [commentThreadById, focusCommentThread, isCompactComment, openAiAssistant, viewPrefs.showCommentPanel]);
