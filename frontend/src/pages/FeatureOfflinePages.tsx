...
function OfflineCard({
  ...
  return (
    <div className="mx-auto mt-20 w-full max-w-2xl rounded-2xl border border-slate-200 bg-white p-10 shadow-sm">
...
export function ProfilePage() {
  ...
  return (
    <div className="min-h-[calc(100vh-4rem)] bg-slate-50 px-6 py-8">
      ...
      />
      <div className="mx-auto mt-4 flex w-full max-w-2xl items-center gap-2 rounded-lg border border-slate-200 bg-white px-4 py-3 text-sm text-slate-600">
