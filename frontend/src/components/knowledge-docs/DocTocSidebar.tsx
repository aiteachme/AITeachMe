          ...
          <div key={item.id} className="my-0.5">
            <div
              ...
              className={cn(
                ...
                isActive
                  ? "bg-indigo-50 text-indigo-700 font-medium dark:bg-indigo-950/40 dark:text-indigo-400"
            ...
            >
              ...
              {isActive && (
                <motion.span
                  ...
                  className="absolute left-0 top-1/2 -translate-y-1/2 w-[3px] h-3.5 rounded-full bg-indigo-600 dark:bg-indigo-400"
              ...
              {hasChildren ? (
                <button
                  ...
                  className={cn(
                    ...
                    isActive
                      ? "text-indigo-700 hover:bg-indigo-100 dark:text-indigo-400 dark:hover:bg-indigo-950/60"
