...
function ModelProbeBadge({ state }: { state: ProbeState | undefined }) {
  ...
  return (
    <span
      className={ok ? "inline-flex items-center gap-1 text-[12px] font-medium text-emerald-600 dark:text-emerald-400" : "inline-flex items-center gap-1 text-[12px] font-medium text-rose-600 dark:text-rose-400"}
      role="status"
      aria-live="polite"
    >
