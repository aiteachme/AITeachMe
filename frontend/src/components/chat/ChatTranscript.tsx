          ...
          >
            ...
            >
              ...
              <div className="min-w-0 flex-1">
                <div
                  className={cn(
                    "mb-1.5 flex items-center gap-2 text-[12px] font-medium tracking-[0.12em]",
                ...
                {isAssistant ? (
                  <div className="max-w-none px-1 py-1 text-base leading-7 text-slate-800 dark:text-slate-100">
                  ...
                  <p className="whitespace-pre-wrap rounded-3xl bg-slate-900 px-4 py-3 text-base leading-7 text-slate-100 shadow-[0_10px_28px_-20px_rgba(15,23,42,0.6)] dark:bg-slate-100 dark:text-slate-900 dark:shadow-[0_18px_30px_-24px_rgba(255,255,255,0.22)]">
                    {message.content}
                  </p>
                )}
