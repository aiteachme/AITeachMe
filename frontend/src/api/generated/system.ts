...
export const initSystemApiV1SystemInitPost = async (initRequest: InitRequest, options?: RequestInit): Promise<initSystemApiV1SystemInitPostResponse> => {
  ...
  const res = await fetch(getInitSystemApiV1SystemInitPostUrl(),
  {      
    ...options,
    method: 'POST',
  ...
  const data: initSystemApiV1SystemInitPostResponse['data'] = body ? JSON.parse(body) : {}
  return { data, status: res.status, headers: res.headers } as initSystemApiV1SystemInitPostResponse
}
...
export const getInitSystemApiV1SystemInitPostMutationOptions = <TError = HTTPValidationError | ErrorResponse,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof initSystemApiV1SystemInitPost>>, TError,{data: InitRequest}, TContext>, fetch?: RequestInit}
...
const {mutation: mutationOptions, fetch: fetchOptions} = options ?
      ...
      const mutationFn: MutationFunction<Awaited<ReturnType<typeof initSystemApiV1SystemInitPost>>, {data: InitRequest}> = (props) => {
          ...
          return  initSystemApiV1SystemInitPost(data,fetchOptions)
        }
