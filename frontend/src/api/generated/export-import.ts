...
export const exportPreviewApiApiV1SubjectsSubjectExportPreviewPost = async (subject: string, options?: RequestInit): Promise<exportPreviewApiApiV1SubjectsSubjectExportPreviewPostResponse> => {
...
export const getExportPreviewApiApiV1SubjectsSubjectExportPreviewPostMutationOptions = <TError = ErrorResponse | HTTPValidationError,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof exportPreviewApiApiV1SubjectsSubjectExportPreviewPost>>, TError,{subject: string}, TContext>, request?: SecondParameter<typeof orvalApiClient>}
): UseMutationOptions<Awaited<ReturnType<typeof exportPreviewApiApiV1SubjectsSubjectExportPreviewPost>>, TError,{subject: string}, TContext> => {
...
const {mutation: mutationOptions, request: requestOptions} = options ?
      ...
      const mutationFn: MutationFunction<Awaited<ReturnType<typeof exportPreviewApiApiV1SubjectsSubjectExportPreviewPost>>, {subject: string}> = (props) => {
          const {subject} = props ?? {};

          return  exportPreviewApiApiV1SubjectsSubjectExportPreviewPost(subject,requestOptions)
        }
